...
export const CAR_MAKES = [
  'Toyota', 'Hyundai', 'Kia', 'Nissan', 'Chevrolet', 'Mercedes-Benz', 'BMW',
  'Volkswagen', 'Renault', 'Peugeot', 'Fiat', 'Skoda', 'Mitsubishi', 'Honda',
  'Ford', 'Opel', 'MG', 'Chery', 'Suzuki', 'Jeep', 'Audi', 'Seat', 'Citroën',
] as const;
