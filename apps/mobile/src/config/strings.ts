...
const ar = {
  ...
  trustNoCommission: 'بدون عمولات',
  searchPillTitle: 'دوّر على عقارك',
  ...
  rentSectionTitle: 'عقارات للإيجار',
  saleSectionTitle: 'عقارات للبيع',
  citySectionTitle: 'عقارات في القاهرة',
  viewAll: 'عرض الكل',
