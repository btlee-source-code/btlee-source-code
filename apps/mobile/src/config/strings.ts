...
const ar = {
  ...
  toastRegisterSuccess: 'تم إنشاء حسابك بنجاح',
  toastLogoutSuccess: 'تم تسجيل الخروج',
  toastListingSubmitted: 'تم إرسال إعلانك بنجاح',
  toastLoginFailed: 'فشل تسجيل الدخول',
  toastListingFailed: 'فشل إرسال الإعلان، حاول مرة أخرى',
  ...
  priceInputPlaceholder: 'اكتب السعر',
  ...
  fFurnishingStatus: 'حالة الفرش',
  finishingPickerTitle: 'اختر حالة التشطيب',
  finishingPickerPlaceholder: 'اختر حالة التشطيب',
  furnishingPickerTitle: 'اختر حالة الفرش',
  furnishingPickerPlaceholder: 'اختر حالة الفرش',
  ...
  maxImagesError: (count: number) => `يمكنك إضافة ${count} صورة كحد أقصى`,
  selectFieldError: (field: string) => `يرجى اختيار ${field}`,
  enterFieldError: (field: string) => `يرجى إدخال ${field}`,
  invalidFieldError: (field: string) => `القيمة المدخلة في ${field} غير صحيحة`,
  fieldMinCharsError: (field: string, count: number) =>
    `يجب ألا يقل ${field} عن ${count} أحرف`,
  fieldMaxCharsError: (field: string, count: number) =>
    `يجب ألا يزيد ${field} عن ${count} حرفًا`,
  positiveNumberError: (field: string) => `يجب أن يكون ${field} رقمًا أكبر من صفر`,
  numberRangeError: (field: string, min: number, max: number) =>
    `يجب أن يكون ${field} بين ${min} و${max}`,
  validWhatsappError: 'أدخل رقم واتساب مصري صحيح مثل 01012345678',
  reviewHighlightedFields: 'راجع الحقول المحددة باللون الأحمر',
  imagesUploadError: 'تعذر رفع الصور. تأكد من اتصال الإنترنت وحاول مرة أخرى',
  listingSubmitError: 'تعذر نشر الإعلان الآن. حاول مرة أخرى بعد قليل',
  ...
  locationSearchPlaceholder: 'ابحث عربي أو English...',
  locationSearchAction: 'بحث',
  locationSearchMinChars: 'اكتب 3 أحرف على الأقل للبحث عن المنطقة',
  locationSearchNoResults: (query: string) => `لا توجد نتائج لـ «${query}»`,
  locationSearchFailed: 'تعذر البحث عن المنطقة الآن. حاول مرة أخرى',
  locationSearchAttribution: 'نتائج البحث © مساهمو OpenStreetMap',
  clearLocationSearch: 'مسح البحث',
  ...
  fCarLocation: 'موقع العربية على الخريطة',
  tapToSetCarLocation: 'دوس على الخريطة لتحديد موقع العربية',
  fCarDescription: 'وصف العربية',
  carDescriptionHint: 'اكتب تفاصيل العربية (10 أحرف على الأقل)',
  phCarDescription: 'اكتب تفاصيل واضحة عن العربية تجذب المهتمين...',
  fMake: 'الماركة',
  carMakePickerPlaceholder: 'اختر الماركة',
  carMakePickerTitle: 'اختر ماركة السيارة',
  carMakePickerSubtitle: 'ابحث واختر الماركة المناسبة لإعلانك',
  carMakePickerSearch: 'ابحث بالعربي أو الإنجليزي...',
  carMakePickerPopular: 'الماركات الأكثر شيوعًا',
  carMakePickerAll: 'جميع الماركات',
  carMakePickerEmpty: 'لم يتم العثور على ماركة',
  fModel: 'الموديل',
  fYear: 'سنة الصنع',
  ...
  fCondition: 'الحالة',
  fColor: 'اللون',
  makeHint: 'اختر ماركة السيارة من القائمة',
...
const en: Partial<Strings> = {
  ...
  toastListingSubmitted: 'Your listing was submitted',
  toastLoginFailed: 'Sign-in failed',
  toastListingFailed: 'Could not submit the listing, please try again',
  ...
  priceInputPlaceholder: 'Enter price',
  ...
  fFurnishingStatus: 'Furnishing status',
  finishingPickerTitle: 'Select finishing condition',
  finishingPickerPlaceholder: 'Select finishing condition',
  furnishingPickerTitle: 'Select furnishing status',
  furnishingPickerPlaceholder: 'Select furnishing status',
  ...
  maxImagesError: (count: number) => `You can add up to ${count} photos`,
  selectFieldError: (field: string) => `Please choose ${field}`,
  enterFieldError: (field: string) => `Please enter ${field}`,
  invalidFieldError: (field: string) => `The value entered for ${field} is invalid`,
  fieldMinCharsError: (field: string, count: number) =>
    `${field} must be at least ${count} characters`,
  fieldMaxCharsError: (field: string, count: number) =>
    `${field} must not exceed ${count} characters`,
  positiveNumberError: (field: string) => `${field} must be greater than zero`,
  numberRangeError: (field: string, min: number, max: number) =>
    `${field} must be between ${min} and ${max}`,
  validWhatsappError: 'Enter a valid Egyptian WhatsApp number, such as 01012345678',
  reviewHighlightedFields: 'Review the fields highlighted in red',
  imagesUploadError: 'Could not upload the photos. Check your connection and try again',
  listingSubmitError: 'Could not publish the listing now. Please try again shortly',
  ...
  locationSearchPlaceholder: 'Arabic or English area...',
  locationSearchAction: 'Search',
  locationSearchMinChars: 'Enter at least 3 characters to search for an area',
  locationSearchNoResults: (query: string) => `No results for “${query}”`,
  locationSearchFailed: 'Could not search for the area. Please try again',
  locationSearchAttribution: 'Search results © OpenStreetMap contributors',
  clearLocationSearch: 'Clear search',
  ...
  fCarLocation: 'Car location on the map',
  tapToSetCarLocation: 'Tap the map to set the car location',
  fCarDescription: 'Car description',
  carDescriptionHint: 'Write the car details (at least 10 characters)',
  phCarDescription: 'Write clear details about the car that attract interested buyers...',
  fMake: 'Make',
  carMakePickerPlaceholder: 'Choose a make',
  carMakePickerTitle: 'Choose car make',
  carMakePickerSubtitle: 'Search and select the right make for your listing',
  carMakePickerSearch: 'Search in Arabic or English...',
  carMakePickerPopular: 'Popular makes',
  carMakePickerAll: 'All makes',
  carMakePickerEmpty: 'No make found',
  fModel: 'Model',
  fYear: 'Year',
  fMileage: 'Mileage (km)',
  ...
  fColor: 'Color',
  makeHint: 'Choose the car make from the list',
