 ...
 * single tap from anywhere on the home, without taking a slot in the layout. It
 * follows the active section: green → add property, blue → add car.
 */
export function AddListingFab() {
  ...
  return (
    <AnimatedPressable
      ...
      style={[
        { bottom: 18, left: 18, height: 52, paddingHorizontal: 20, backgroundColor: c.primary },
        shadows.lg,
      ]}>
      <Plus size={22} color={c.primaryForeground} strokeWidth={2.6} />
      <Text className="font-cairo-bold text-[15px]" style={{ color: c.primaryForeground }}>
        {S.addNew}
      </Text>
    </AnimatedPressable>
  );
